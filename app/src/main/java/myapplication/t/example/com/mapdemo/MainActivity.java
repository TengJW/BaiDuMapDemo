...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    public void onLocation(String city, String rode, double latitude, double longitude) {
        this.city = city;
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            onLocation(location.getCity(), location.getLocationDescribe(), location.getLatitude(), location.getLongitude());
        }
    }
